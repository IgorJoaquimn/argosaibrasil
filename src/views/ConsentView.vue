        ...
        <div class="bg-background-light border border-primary-200 rounded-lg px-6 py-8 max-h-[600px] overflow-y-auto">
          ...
          <div class="text-primary-500 leading-relaxed space-y-4 px-4">
           ...
           <p class="font-semibold text-lg pl-2">Seja bem-vindo(a)!</p>
            ...
            <p>Esta pesquisa está sendo realizada por pesquisadores do <span style="font-weight: 700;">Departamento de Ciência da Computação da Universidade Federal de Minas Gerais (UFMG)</span> e visa entender melhor as <span style="font-weight: 700;">percepções da comunidade acadêmica</span> sobre a inteligência artificial.</p>
            <br>

            <p>A sua participação consiste em responder a um <span style="font-weight: 700;">questionário anônimo</span>, com perguntas sobre sua <span style="font-weight: 700;">opinião, experiências e percepções</span> relacionadas ao tema.</p>
            <br>
            ...
            <br>
            <p>Em caso de dúvidas, você pode entrar em contato com a equipe de pesquisa pelo e-mail: <a href="mailto:argosiabrasil@gmail.com" class="text-primary-600 hover:text-primary-700 underline">argosiabrasil@gmail.com</a>.</p>
            <br>
